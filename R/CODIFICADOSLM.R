...
#'
#' Esta funcion esta creada para codificar la solapa de SL de una UG municipal
#' Requiere algunos pre requisitos: 
#' Debemos tener cargados algunos objetos previo a la utilizacion de esta funcion:
#' 
...
#' CODISL : Solapa de proyectos socio laborales
#' 
...
CODIFICADOSLM <- function(MUNI, NPRO) {
